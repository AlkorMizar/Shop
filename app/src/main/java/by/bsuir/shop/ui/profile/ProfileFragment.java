...
import by.bsuir.shop.BuildConfig;
...
public class ProfileFragment extends Fragment implements OnMapReadyCallback {
    ...
    private String MAPS_API_KEY = "AIzaSyC20bFTnQBvXX6lu15BMUMp78Hpjpf0K4c";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Places.initialize(ShopApplication.getAppContext(), MAPS_API_KEY);
    ...
    private void getDeviceLocation() {
        ...
        try {
            if (locationPermissionGranted) {
                ...
                locationResult.addOnCompleteListener( this.getActivity(), (OnCompleteListener<Location>) task -> {
    ...
    private void getLocationPermission() {
         ...
         */
        if (ContextCompat.checkSelfPermission(ShopApplication.getAppContext(),
